package com.paulofreitas.helpdesk.api.controller;
...
import com.paulofreitas.helpdesk.api.dto.Summary;
import com.paulofreitas.helpdesk.api.entity.ChangeStatus;
import com.paulofreitas.helpdesk.api.entity.Ticket;
import com.paulofreitas.helpdesk.api.entity.User;
import com.paulofreitas.helpdesk.api.enums.ProfileEnum;
import com.paulofreitas.helpdesk.api.enums.StatusEnum;
import com.paulofreitas.helpdesk.api.response.Response;
import com.paulofreitas.helpdesk.api.security.jwt.JwtTokenUtil;
import com.paulofreitas.helpdesk.api.service.TicketService;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> createOrUpdate (HttpServletRequest request, @RequestBody Ticket ticket, BindingResult result) {
		...
		try {
			validateTicketUser(ticket, result);
			if(result.hasErrors()) {
			...
			Ticket ticketPersited = (Ticket) ticketService.createOrUpdate(ticket);
	...
	public ResponseEntity<Response<Ticket>> changeStatus (
		...
		try {
		    ...
		    Ticket ticketPersited = (Ticket) ticketService.createOrUpdate(ticketCurrent);
	...
	private void validateTicketUser(Ticket ticket, BindingResult result) {
